...
require('gitsigns').setup(
	{
		on_attach = function(bufnr)
			...
			map('v', '<leader>hS', gitsigns.stage_buffer)
			map('v', '<leader>hR', gitsigns.reset_buffer)
			map('v', '<leader>hp', gitsigns.preview_hunk)
			map('v', '<leader>hi', gitsigns.preview_hunk_inline)
